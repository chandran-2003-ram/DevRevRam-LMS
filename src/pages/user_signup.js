...
const Signup = () => {
  ...
  return (
    <div style={{ width:"100vw", height:"100vh", display:"flex", flexDirection:"column", backgroundRepeat:"no-repeat"}}>
      ...
      <div className="p-4 box"style={{backgroundColor: "white" ,width:"400px", height:"350px", alignContent:"center" , borderTopLeftRadius:"25px", borderTopRightRadius:"25px" , borderBottomRightRadius:"25px", borderBottomLeftRadius:"25px", marginLeft:"750px", marginTop:"200px"}}  >
        <h2 className="mb-3 text-center" style={{fontFamily:"Times New Roman", fontWeight:"50px"}}>SignUp</h2>
